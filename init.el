...
(mapcar #'add-to-path '("/usr/local/bin" "/usr/local/share/python" "~/bin"))
...
(load "~/.emacs.d/indent.el")
(load "~/.emacs.d/keymap.el")
(load "~/.emacs.d/emacs-config-helpers.el")
