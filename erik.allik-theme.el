...
(custom-theme-set-faces
 'erik.allik
 '(default ((t (:family "Monaco" :foundry "apple" :width normal :height 150 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "black" :stipple nil :inherit nil))))
